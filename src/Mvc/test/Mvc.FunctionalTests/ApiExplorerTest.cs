...
public class ApiExplorerTest : LoggedTest
{
    ...
    public async Task ApiExplorer_LogsInvokedDescriptionProvidersOnStartup()
    {
        ...
        Assert.Contains(TestSink.Writes, w => w.Message.Equals("Executing API description provider 'DefaultApiDescriptionProvider' from assembly Microsoft.AspNetCore.Mvc.ApiExplorer v12.0.0.0.", StringComparison.Ordinal));
